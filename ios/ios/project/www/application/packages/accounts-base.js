...
var AccountsClient = exports.AccountsClient = function (_AccountsCommon) {                                           //
  ...
  // @override                                                                                                       //
                                                                                                                     //
                                                                                                                     //
  AccountsClient.prototype.userId = function userId() {                                                              //
  ...
  // method call too.                                                                                                //
                                                                                                                     //
                                                                                                                     //
  AccountsClient.prototype._setLoggingIn = function _setLoggingIn(x) {                                               //
   ...
   */                                                                                                                //
                                                                                                                     //
                                                                                                                     //
  AccountsClient.prototype.loggingIn = function loggingIn() {                                                        //
   ...
   */                                                                                                                //
                                                                                                                     //
                                                                                                                     //
  AccountsClient.prototype.logout = function logout(callback) {                                                      //
    var self = this;                                                                                                 // 67
   ...
   */                                                                                                                //
                                                                                                                     //
                                                                                                                     //
  AccountsClient.prototype.logoutOtherClients = function logoutOtherClients(callback) {                              //
    var self = this;                                                                                                 // 86
                                                                                                                     //
        ...
        self.connection.onReconnect = function () {                                                                  // 223
          ...
          if (self._tokenExpiresSoon(result.tokenExpires)) {                                                         // 235
            ...
            self.callLoginMethod({                                                                                   // 238
              ...
              userCallback: function userCallback(error) {                                                           // 244
...
var AccountsTest = exports.AccountsTest = {                                                                          // 81
  attemptToMatchHash: function attemptToMatchHash(hash, success) {                                                   // 82
